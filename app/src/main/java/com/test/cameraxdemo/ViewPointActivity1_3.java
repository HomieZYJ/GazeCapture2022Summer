...
public class ViewPointActivity1_3 extends AppCompatActivity {
    ...
    public void stopVideo(View view) {
        ...
        //跳转到下个界面
        Intent intent = new Intent(this,SumActivity1_3.class);
    ...
    private void startAnimation (int[][] redpoint_id_array,int[][] num_id_array){
        ...
        while(!isEnding(max_i,max_j)){
            ...
            j=position[1];
            isVisited[i][j]=1;
            mFileOperation.writeData(txt_savePath,"Txt1_3_"+time_mills,"位置："+"("+i+","+j+")");
            ImageView redpoint;
            TextView number;
            ...
            mHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    //红点的缩小和消失
                    mFileOperation.writeData(txt_savePath,"Txt1_3_"+time_mills,"时刻1："+System.currentTimeMillis());
    ...
    private void startRecord() {
        if (mVideoCapture != null) {
            ...
            File file = new File(savePath,"Video1_3_"+time_mills+".mp4");
            if (file.exists()) {
                file.delete();
            }
            ...
            mVideoCapture.startRecording(build, CameraXExecutors.mainThreadExecutor(), new VideoCapture.OnVideoSavedCallback() {
                ...
                public void onVideoSaved(@NonNull VideoCapture.OutputFileResults outputFileResults) {
                    Toast.makeText(ViewPointActivity1_3.this, "视频保存成功:保存位置-我的手机/Android/data/com.test.cameraxdemo/files/camera ", Toast.LENGTH_LONG).show();
                }
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mCamera = cameraProvider.bindToLifecycle(ViewPointActivity1_3.this, cameraSelector, preview,mImageCapture,mVideoCapture);
